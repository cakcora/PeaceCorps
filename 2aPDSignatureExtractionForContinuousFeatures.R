...
for(nodeFeature in nodeFeatures){
  ...
  whichInputFile<-paste0(nodeFeature,whichInputFile)
  ...
  # we create an (0,100) interval for the birth and death thresholds
  data$birth<-100*round(data$birth,2)
  data$death<-100*round(data$death,2)
